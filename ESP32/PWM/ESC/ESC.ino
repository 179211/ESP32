...
#define ESC_PIN 4 // connected to ESC control wire
#define LED_BUILTIN 2 // not defaulted properly for ESP32s/you must define it
#define POT_PIN 15 // Analog pin used to connect the potentiometer center pin
...
void loop() {
    ...
    myESC.speed(MIN_SPEED); // sets the ESC speed
